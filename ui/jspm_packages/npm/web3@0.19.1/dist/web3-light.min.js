...
(function(process) {
  require = function t(e, n, r) {
    ...
    22: [function(t, e, n) {
      function r(t) {
        this._requestManager = new o(t), this.currentProvider = t, this.eth = new a(this), this.db = new s(this), this.shh = new c(this), this.net = new u(this), this.personal = new f(this), this.bzz = new p(this), this.settings = new l, this.version = {api: h.version}, this.providers = {
          HttpProvider: b,
          IpcProvider: _
    ...
    38: [function(t, e, n) {
      ...
      var w = function() {
        ...
        return [t, e, n, r, s, c, u, f, p, l, h, d, B, S, m, x, w, k, C, A, F, I, T];
      },
          x = function() {
            return [new s({
              name: "coinbase",
      ...
      r.prototype.contract = function(t) {
        ...
        return new p(this._requestManager, t, f.eth(), o.outputLogFormatter, e, n);
          ...
          var c = t,
              ...
              b = l.RIPEMD160 = p.extend({
                ...
                _doProcessBlock: function(t, e) {
                  ...
                  for (var E,
                      c = 0; c < 80; c += 1)
                    E = p + t[e + T[c]] | 0, E += c < 16 ? n(l, b, _) + F[0] : c < 32 ? r(l, b, _) + F[1] : c < 48 ? o(l, b, _) + F[2] : c < 64 ? i(l, b, _) + F[3] : a(l, b, _) + F[4], E |= 0, E = s(E, P[c]), E = E + w | 0, p = w, w = _, _ = s(b, 10), b = l, l = E, E = x + t[e + D[c]] | 0, E += c < 16 ? a(k, B, S) + I[0] : c < 32 ? i(k, B, S) + I[1] : c < 48 ? o(k, B, S) + I[2] : c < 64 ? r(k, B, S) + I[3] : n(k, B, S) + I[4], E |= 0, E = s(E, O[c]), E = E + C | 0, x = C, C = S, S = s(B, 10), B = k, k = E;
            ...
            _doProcessBlock: function(t, e) {
              for (var n = this._hash.words,
                ...
                var pt = N & j ^ ~N & q,
                    ...
                    gt = (H >>> 14 | N << 18) ^ (H >>> 18 | N << 14) ^ (H << 23 | N >>> 9),
                    bt = u[J],
                    _t = bt.high,
                    wt = bt.low,
                    xt = W + gt,
                ...
                U = q, W = L, q = j, L = z, j = N, z = H, H = M + xt | 0, N = R + kt + (H >>> 0 < M >>> 0 ? 1 : 0) | 0, R = O, M = E, O = D, E = P, D = I, P = T, T = xt + Bt | 0, I = kt + St + (T >>> 0 < xt >>> 0 ? 1 : 0) | 0;
              }
              d = r.low = d + T, r.high = h + I + (d >>> 0 < T >>> 0 ? 1 : 0), y = o.low = y + P, o.high = m + D + (y >>> 0 < P >>> 0 ? 1 : 0), g = i.low = g + E, i.high = v + O + (g >>> 0 < E >>> 0 ? 1 : 0), _ = a.low = _ + M, a.high = b + R + (_ >>> 0 < M >>> 0 ? 1 : 0), x = s.low = x + H, s.high = w + N + (x >>> 0 < H >>> 0 ? 1 : 0), B = c.low = B + z, c.high = k + j + (B >>> 0 < z >>> 0 ? 1 : 0), C = p.low = C + L, p.high = S + q + (C >>> 0 < L >>> 0 ? 1 : 0), F = l.low = F + W, l.high = A + U + (F >>> 0 < W >>> 0 ? 1 : 0);
            },
            _doFinalize: function() {
              var t = this._data,
                  e = t.words,
      ...
      !function(t) {
        ...
        function o(t) {
          for (var e,
              ...
              r = -1,
              o = ""; ++r < n; )
            e = t[r], e > 65535 && (e -= 65536, o += g(e >>> 10 & 1023 | 55296), e = 56320 | 1023 & e), o += g(e);
          return o;
        }
        function i(t) {
          if (t >= 55296 && t <= 57343)
